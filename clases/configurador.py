...
class ConfigModel(BaseModel):
    ...
    evaluaciones_BT: list[Annotated[int, Field(gt=0)]] = Field(alias='EVALUACIONES_BT')
    profundidadBT: list[Annotated[int, Field(gt=0)]] = Field(alias='PROFUNDIDAD_BT')
    ...
    tenencia: list[Annotated[int, Field(gt=0)]] = Field(alias='TENENCIA')
